...
![75V 电源控制盒|600](./img/power-box-75v.png)

## 规格

| 项目               | 描述                                                         |
| :----------------- | :----------------------------------------------------------- |
| **适用平台**       | 64V 电源平台（产品型号：75V 电源控制盒）                     |
| **充电输入**       | 55V，板载 15A 保险丝                                         |
| **2x2P 5V 输出**   | 5V，额定 3.5A，包含 LED 灯带信号输出                         |
| **2x3P 12V 输出**  | 稳压 12V，上排为正极，下排为 GND                             |
| **大电流直通输出** | 输出电压随电池电压变化；电机和 JACK 两路带双向电流采样       |
...
| 端子                       | 功能                 | 说明                                                                                      |
| :------------------------- | :------------------- | :---------------------------------------------------------------------------------------- |
| **电池复合端子**           | 总电源输入与电池通信 | 大电流触点连接电池正、负极；小信号触点用于 BMS 串口。BMS 信号包括 3.3V、TX、RX 和 GND。   |
| **XT30**                   | 充电输入             | 接充电器，设计充电电压为 55V，板载 15A 保险丝。                                           |
| **2.54mm 4P**              | CAN 总线接口         | 接算力盒 CAN 总线。1、4 脚未连接，2、3 脚分别为 CANL、CANH。端子型号：DB2ERC-2.54-4P-GN。 |
| **2x2P**                   | 直通供电输出         | 电压随电池电压变化，连接到受电子保险丝保护的系统母线。                                    |
| **2x3P**                   | 稳压 12V 输出        | 三路并联输出，上排为 12V，下排为 GND。                                                    |
| **电机 / JACK 大电流端子** | 直通供电输出         | 两路输出分别带双向电流采样，可检测负载电流和回馈电流；输出受总线电子保险丝保护。          |
