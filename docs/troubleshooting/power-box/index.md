...
震动的时候（比如晃动、或者运动中），有时候长鸣5秒断电，有时候突然断电。有两个可能：

### 意外断电可能性1：电源线 XT60 的端子接触不良

分析方法：

1. 开机。
2. 尝试晃动电源盒总电源 XT60 端子（手抓线，左右晃、上下晃、中等力气拔）。观察是否松动，是否会出现意外断电。如果出现问题，则进行下一步：
...
1. 离开充电桩，关机，再开机。（因为正在充电的时候，会降低轮子扭矩。所以这样操作一下，避免这种情况。）
2. 确保轮子已经充分使能。此时用力推动机器人，明显感觉到轮子力气很大，推不动。
3. 抓住机器人，用全力反复推拉。如视频所示。
4. 如果发力瞬间长鸣、并关机。有可能是这个问题，需要进一步排除 XT60 接触不良的可能。
5. 如果已经排除 XT60 接触不良的可能，则更换电源盒。
...
<figure className="img-container">
  ...
  />
  <figcaption>演示视频：推拉机器人测试</figcaption>
</figure>
